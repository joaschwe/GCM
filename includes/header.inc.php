...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-136802650-1"></script>
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-136802650-2"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-136802650-1');
  gtag('config', 'UA-136802650-2');
</script>
